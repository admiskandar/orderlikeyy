    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="{{ route('menu.add') }}" class="btn btn-added"><img src="{{ asset('build') }}/assets/img/icons/plus.svg" alt="img" class="me-1">Add New Menu</a>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <a class="me-3" href="{{ route('menu.edit', [$menu->id])}}">
                                                <img src="{{ asset('build') }}/assets/img/icons/edit.svg" alt="img">
                                            </a>
                                            <a class="confirm-text" href="{{ route('menu.destroy', [$menu->id])}}">
