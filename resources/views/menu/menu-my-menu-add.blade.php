<x-app-layout>
    <div class="page-wrapper">
        <div class="content">
            ...
            <!-- /add -->
            <form action="{{ route('menu.my.menu.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm();">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div class="col-6">
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="menu_category[]" value="Cuisine"> Cuisine
                                            </label>
                                        </div>
                                    </div>
